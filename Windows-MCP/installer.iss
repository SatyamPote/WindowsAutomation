...
Source: "dist\LotusTray.exe";          DestDir: "{app}";                 Flags: ignoreversion skipifsourcedoesntexist
...
Name: "{app}\data"
Name: "{app}\storage"
Name: "{app}\storage\audio"
Name: "{app}\storage\videos"
Name: "{app}\storage\images"
Name: "{app}\storage\screenshots"
Name: "{app}\storage\recordings"
Name: "{app}\storage\research"

[Icons]
Name: "{group}\Lotus Control Panel"; Filename: "{app}\Lotus.exe"; IconFilename: "{app}\assets\lotus_icon.ico"
Name: "{group}\Lotus (System Tray)"; Filename: "{app}\LotusTray.exe"; IconFilename: "{app}\assets\lotus_icon.ico"
Name: "{autodesktop}\Lotus";         Filename: "{app}\Lotus.exe"; IconFilename: "{app}\assets\lotus_icon.ico"; Tasks: desktopicon

[Tasks]
Name: "desktopicon"; Description: "Create a &desktop shortcut"; GroupDescription: "Additional shortcuts:"
Name: "startupicon"; Description: "Launch Lotus on Windows startup (system tray)"; GroupDescription: "Startup options:"

[Registry]
Root: HKCU; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; ValueName: "LotusTray"; ValueData: """{app}\LotusTray.exe"""; Flags: uninsdeletevalue; Tasks: startupicon

[Run]
Filename: "{app}\Lotus.exe"; Description: "Launch Lotus"; Flags: nowait postinstall skipifsilent

[UninstallRun]
Filename: "taskkill.exe"; Parameters: "/F /IM LotusTray.exe /T"; Flags: runhidden; RunOnceId: "KillTray"
Filename: "taskkill.exe"; Parameters: "/F /IM Lotus.exe /T";     Flags: runhidden; RunOnceId: "KillApp"
Filename: "reg"; Parameters: "delete ""HKCU\Software\Microsoft\Windows\CurrentVersion\Run"" /v LotusTray /f"; Flags: runhidden; RunOnceId: "RemoveStartup"
Filename: "reg"; Parameters: "delete ""HKCU\Software\Microsoft\Windows\CurrentVersion\Run"" /v LotusControlPanel /f"; Flags: runhidden; RunOnceId: "RemoveOldStartup"
