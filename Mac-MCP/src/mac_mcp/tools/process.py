...
def register(mcp, *, get_desktop, get_analytics):
    @mcp.tool(
        name="Process",
        description=(
            'List and kill running processes. Keywords: task manager, running tasks, kill, terminate, '
            'stop process, PID, CPU, memory usage. '
            'Use mode="list" to list running processes with filtering and sorting options. '
            'Use mode="kill" to terminate processes by PID or name.'
        ),
