...
from mac_mcp import filesystem
...
def register(mcp, *, get_desktop, get_analytics):
    @mcp.tool(
        name="FileSystem",
        description=(
            "Manages file system operations with eight modes: "
            ...
            "'info' (get file/directory metadata like size, dates, type). "
            "Relative paths are resolved from the user's Desktop folder. "
    ...
    def file_system_tool(
        ...
        try:
            ...
            return f"Error in FileSystem tool: {e}"
